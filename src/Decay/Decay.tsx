...
import Animated, { Value, cond, eq, set, add, Clock, block, clockRunning, startClock, and, not, decay, stopClock, neq } from 'react-native-reanimated';
